          ...
          <Container>
            <Form.Group className="mb-4 mt-3">
              <input id="faq_no" name="faq_no" type="hidden" 
                    defaultValue={pointVO.POINT_NO} onChange={onChange} />
              <Form.Label className="member_no">회원번호</Form.Label>
              <Form.Control
                  type='text' name='member_no' size="lg" onChange={onChange} 
                  defaultValue={pointVO.MEMBER_NO} disabled readOnly />
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                    type='text' name='point_used_saved' size="lg" 
                    defaultValue={pointVO.POINT_USED_SAVED} onChange={onChange}  />
            </Form.Group>
          </Container>
