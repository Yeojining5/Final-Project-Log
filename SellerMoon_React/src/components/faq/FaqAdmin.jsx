  ...
  const sortTitle = () => {
      ...
      if(sortBtn === 0) {
        ...
        setTitle("제목 ▼");
          ...
          setFaqList(sorting1.sort((a,b) => a.FAQ_TITLE.toLowerCase() > b.FAQ_TITLE.toLowerCase() ? -1 : 1))
  ...
  const sortCount = () => {
    ...
    if(sortBtn === 0) {
      setHitCount("조회수 ▲");
        setFaqList(
          sorting2.sort((a, b) => 
          a.FAQ_VIEW_COUNT < b.FAQ_VIEW_COUNT ? -1 : 1)
        )
      setSortBtn(1); /* 버튼 상태를 1로 - 토글 */
    } else if (sortBtn === 1) {
      setHitCount("조회수 ▼");
            ...
            <Row>
              ...
              <Col xs={12} md={8}>
                <Form.Group className="mb-5 mt-3">
                  ...
                  <Form.Control
                    name='faq_content' onChange={onChange}  
                    as="textarea" rows={13} />
                </Form.Group>
              </Col>
            </Row>
