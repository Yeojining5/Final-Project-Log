...
const Friends = ({ pointList }) => {
  ...
  const copyCode = () => {
    ...
    setTimeout(() => { setAlert(false) }, 2000) /* 2초뒤 창닫힘 */
  }
            ...
            <div className="list-wrapper">
              ...
              <NavbarMypage pointList={pointList} />
                ...
                <div style={{textAlign: "center", marginBottom: "150px"}}>
                  ...
                  {/* <FRIEND_CODE>YE98QYQU</FRIEND_CODE> */} {/* ##################################### 상수 */}
                  <FRIEND_CODE value="YE98QYQU" id="friendCode" readOnly/> {/* ############################# 상수 */}
                  ...
                  <ul style={{ marginTop: "10px", marginBottom: "100px" }}>
                    <POINT_LI>
                      친구초대 적립금은 초대코드를 통해 가입한 친구가 회원 가입 완료 시 자동 지급됩니다.
                    </POINT_LI>  
                    <POINT_LI>
                      본 이벤트에 대한 허위/과장 정보를 게시하거나, 이벤트 혜택을 기반으로
                      타인에게 금전거래를 요구하는 등 이벤트의 취지에 맞지 않는 <br/> 부정 행위가
                      확인되는 경우 이벤트 포인트 회수 혹은 이벤트 참여 제한 등의 조치가
                      적용될 수 있습니다.
                    </POINT_LI>  
                    <POINT_LI>
