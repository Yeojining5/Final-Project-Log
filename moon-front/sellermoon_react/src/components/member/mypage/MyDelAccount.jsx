...
const MyDelAccount = ({ no, isLogin, logout, myPoint, mySubs }) => {
  ...
  return (
    ...
    <div className="d-flex justify-content-center" style={{color: "rgb(51, 51, 51)"}}>
      <div style={{ border: "2px solid #b29d82", width: "700px", padding:"60px 70px", float:"center"}}>
          ...
          <ul style={{fontWeight:"500", fontSize: "20px", lineHeight:"38px"}}>
            <li>보유 적립금&nbsp; 
              <strong style={{color:"rgb(255, 72, 0)"}}>{myPoint.POINT_SUM.toLocaleString()} Point</strong>
            </li>
            <li>정기구독 무료배송 서비스</li>
          ...
          <div className="d-flex mt-4">
            <ORDER_CHECK value={isCheck} type="checkbox" id="flexCheckDefault" onChange={isChecked} />
            <ORDER_CHECKS>(필수) 내용을 확인했으며, 회원 탈퇴에 동의합니다.</ORDER_CHECKS>
          </div>

          <div className="d-flex justify-content-center mt-5">
            <BROWN_BTN2 onClick={delMem}>
              회원 탈퇴
            </BROWN_BTN2>
          </div>
      </div>
