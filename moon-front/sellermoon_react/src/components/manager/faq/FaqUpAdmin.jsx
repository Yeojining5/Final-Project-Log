...
/* *************************************************  */
  ...
  const faqUpdate = (e) => {
    ...
    const faq_category = document.querySelector("#faq_category").value;
    console.log(faq_category); /* option value="정기구독" 이부분 출력됨 */
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <th>카테고리</th>
                  <td colSpan={4}>
                    <p>선택된 내용 : {faqVO.FAQ_CATEGORY}</p>
                    <Form.Select aria-label="Default select example" size="md"
                      id="faq_category" name="faq_category" style={{width:"50%"}}>
                      <option>변경선택</option>
